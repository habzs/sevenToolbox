! function r(s, a, l) {
    ...
    3: [function (t, e, i) {
        ...
        function r(t) {
            if (0 === t.button) {
                null === this.getAttribute("disabled") && function (i) {
                    var n = i.parentNode,
    ...
    5: [function (t, e, i) {
        ...
        e.exports = {
            getMenuPositionalCSS: function (t, e, i) {
                var n, o, r, s, a = document.documentElement.clientHeight,
                    l = e.children.length,
            ...
            removeClass: function (t, e) {
                if (e && t.setAttribute) {
                    for (var i, n = c(t), o = e.split(" "), r = 0; r < o.length; r++)
                        for (i = o[r].trim(); 0 <= n.indexOf(" " + i + " ");) n = n.replace(" " + i + " ", " ");
                    t.setAttribute("class", n.trim())
                }
            },
            type: l,
    ...
    7: [function (t, e, i) {
        ...
        e.exports = {
            ...
            dispatchEvent: function (t, e, i, n, o) {
                ...
                if (i = void 0 === i || i, n = void 0 === n || n, s.initEvent(e, i, n), o)
                    for (r in o) s[r] = o[r];
            ...
            enableScrollLock: function () {
                if (1 === (f += 1)) {
                    ...
                    t = ["overflow:hidden"], a && (r.scrollHeight > r.clientHeight && (i = parseInt(m.css(s, "padding-right")) + a, t.push("padding-right:" + i + "px")), r.scrollWidth > r.clientWidth && (i = parseInt(m.css(s, "padding-bottom")) + a, t.push("padding-bottom:" + i + "px"))), e = "." + p + "{", e += t.join(" !important;") + " !important;}", u = h(e), m.on(o, "scroll", c, !0), l = {
                        left: m.scrollLeft(o),
                        top: m.scrollTop(o)
                    }, m.addClass(s, p)
                }
    ...
    10: [function (t, e, i) {
        ...
        p.prototype._createMenuEl = function (t, e) {
            var i, n, o, r, s, a, l, u, c = E.createElement("div"),
                d = e.children,
                m = this.itemArray,
                f = 0,
                p = -1,
    ...
    11: [function (t, e, i) {
        ...
        function s(t) {
            var e, i, n, o, r, s, a, l, u, c = t.parentNode,
                d = t.getAttribute(h),
                m = document.getElementById(d);
            f.hasClass(c, v) || (m || p.raiseError('Tab pane "' + d + '" not found'), n = (i = function (t) {
                var e, i = t.parentNode.children,
                    n = i.length,
                    o = null;
                for (; n-- && !o;)(e = i[n]) !== t && f.hasClass(e, v) && (o = e);
                return o
            }(m)).id, u = "[" + h + '="' + n + '"]', o = document.querySelectorAll(u)[0], e = o.parentNode, r = {
                paneId: d,
                relatedPaneId: n
            }, s = {
                paneId: n,
